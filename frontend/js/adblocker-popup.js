...
(function () {
    function showAdblockerPopup() {
        ...
        function setInitialUIText() {
            modal.querySelector('[data-i18n="adblocker.title"]').textContent =
                window.i18n && i18n.t
                    ? i18n.t('adblocker.title') || 'Enhance Your Experience: Install an Adblocker'
                    : 'Enhance Your Experience: Install an Adblocker';
            modal.querySelector('[data-i18n="adblocker.description"]').textContent =
                window.i18n && i18n.t
                    ? i18n.t('adblocker.description') ||
                      'Adblockers provide a smoother, ad-free experience and protect you from malicious ads and trackers. Stay safe and virus-free while you stream!'
                    : 'Adblockers provide a smoother, ad-free experience and protect you from malicious ads and trackers. Stay safe and virus-free while you stream!';
        }
        setInitialUIText();
        ...
        function updateUIText() {
            modal.querySelector('[data-i18n="adblocker.title"]').textContent =
                i18n.t('adblocker.title');
            modal.querySelector('[data-i18n="adblocker.description"]').textContent =
                i18n.t('adblocker.description');
            modal.querySelector('[data-i18n="adblocker.dont_show"]').textContent =
            ...
            if (!found) {
                actionsDiv.innerHTML =
                    `<div style='margin-bottom:8px;'>${i18n.t('adblocker.fallback') || 'We recommend these popular adblockers for your browser:'}</div>` +
                    genericList
                        .map(function (item) {
